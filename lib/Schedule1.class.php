...
include_once($basedir . '/templates/schedule1.template.php');
  ...
  /*      for ($dayCount = 0; $dayCount < $this->viewdays; $dayCount++) {
    ...
    */
    function get_date_vars() {
       ...
       $indate=array();
       $indate[0]=$_POST['Month'];
       $indate[1]=$_POST['Day'];
       $indate[2]=$_POST['Year'];
	echo  $indate[0]. ' ' .  $indate[1] . ' ' .  $indate[2];
