...
require_once($basedir . '/templates/reserve1.template.php');
// AK: Required to get number of reservations
require_once($basedir . '/lib/ReservationSearch1.php');
	...
	*/
	function print_success($verb, $dates = array()) {
		...
		CmnFns::do_message_box(translate('Your ' . $this->word . ' was successfully ' . $verb)
					...
					. $date_text . '<br/><br/>'
					. '<a href="http://encyclopedia.gwu.edu/srrs/ctrlpnl1.php">' . translate('Close') . '</a>'
					, 'width: 90%;');
	}
